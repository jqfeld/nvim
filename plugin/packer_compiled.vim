...
_G.packer_plugins = {
  ...
  ["completion-buffers"] = {
    loaded = true,
    path = "/home/jk/.local/share/nvim/site/pack/packer/start/completion-buffers"
  },
  ["completion-nvim"] = {
    loaded = true,
    path = "/home/jk/.local/share/nvim/site/pack/packer/start/completion-nvim"
  },
  ["csv.vim"] = {
    loaded = true,
    path = "/home/jk/.local/share/nvim/site/pack/packer/start/csv.vim"
  },
  ["dashboard-nvim"] = {
    loaded = true,
    path = "/home/jk/.local/share/nvim/site/pack/packer/start/dashboard-nvim"
  },
  ["gruvbox.nvim"] = {
    loaded = true,
    path = "/home/jk/.local/share/nvim/site/pack/packer/start/gruvbox.nvim"
  },
  ["iron.nvim"] = {
    loaded = true,
  ...
  kommentary = {
    loaded = true,
    path = "/home/jk/.local/share/nvim/site/pack/packer/start/kommentary"
  },
  ["lsp_extensions.nvim"] = {
    loaded = true,
    path = "/home/jk/.local/share/nvim/site/pack/packer/start/lsp_extensions.nvim"
  },
  ["lspsaga.nvim"] = {
    loaded = true,
    path = "/home/jk/.local/share/nvim/site/pack/packer/start/lspsaga.nvim"
  },
  ["lualine.nvim"] = {
    loaded = true,
  ...
  ["lush.nvim"] = {
    loaded = true,
    path = "/home/jk/.local/share/nvim/site/pack/packer/start/lush.nvim"
  },
  ["markdown-preview.nvim"] = {
    commands = { "MarkdownPreview" },
    loaded = false,
    needs_bufread = false,
    path = "/home/jk/.local/share/nvim/site/pack/packer/opt/markdown-preview.nvim"
  },
  neogit = {
    loaded = true,
  ...
  ["neuron.nvim"] = {
    loaded = true,
    path = "/home/jk/.local/share/nvim/site/pack/packer/start/neuron.nvim"
  },
  ["nlua.nvim"] = {
    loaded = true,
    path = "/home/jk/.local/share/nvim/site/pack/packer/start/nlua.nvim"
  },
  ["nvim-lspconfig"] = {
    loaded = true,
  ...
  ["rust.vim"] = {
    loaded = true,
    path = "/home/jk/.local/share/nvim/site/pack/packer/start/rust.vim"
  },
  ["telescope.nvim"] = {
    loaded = true,
